...
val ColorScheme.splashScreenBackgroundColor: Color
    @Composable
    get() = if (isSystemInDarkTheme()) Color.Black else Color(53, 24, 90)
...
val ColorScheme.taskItemTitleColor: Color
    @Composable
    get() = if (isSystemInDarkTheme()) Color.LightGray else DarkGray